...
public class MachineForm extends javax.swing.JInternalFrame {
    ...
    public MachineForm() {
        try {
            ...
            dao = (IDao<Machine>) Naming.lookup("rmi://localhost:1099/daoM"/*"rmi://"+Config.ip+":"+Config.port+"/dao"*/);
      ...
      public void fillForm(){
         try {
            ...
            for(int i=1;i< jComboBox1.getItemCount();i++){
                if(m.getSale().getId() == ((Sale) jComboBox1.getItemAt(i)).getId()){
                    System.out.println((Sale) jComboBox1.getItemAt(i));
